...
const HomeScreen = ({ navigation }) => {
  ...
  // const temp = [...plants, ...(plants.length > 3 ? [] : [{ isPlus: true }])];
  const calDay = (item) => {
      ...
      <SafeAreaView style={styles.container}>
        <Carousel
          ...
          renderItem={
              ...
              item.isPlus ? (
                ...
                <View style={styles.cardPlant}>
                  <Image
                    ...
                    style={{
                      width: '100%', //windowWidth * 0.85
                      height: windowHeight * 0.65, //windowHeight * 0.65
                      alignSelf: 'center',
                    }}
                    resizeMode="contain"
                  />
                  ...
                  >
                    <Text
                      style={{ fontFamily: 'notoSansKR-bold', fontSize: 20 }}
                    >
                      {item.nickname}
                    </Text>
                  </View>
            ...
            //     <Text style={styles.plantNickname}>{item.plantDay}</Text>
            //     <Text style={styles.plantNickname}>{item.lastWater}</Text>
            //     <Text>D - {calDay(item)}</Text>
            //     <Text style={styles.plantNickname}>{item.type}</Text>
            //     <Text style={styles.plantNickname}>{item.waterCycle}</Text>
